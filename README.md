...
4. Select the `deaddupe` folder
5. The extension icon should appear in your toolbar

## How to Use

1. Click the DeadDupe extension icon in your Chrome toolbar
...
3. Click the refresh icon on the DeadDupe extension card
4. Test your changes
